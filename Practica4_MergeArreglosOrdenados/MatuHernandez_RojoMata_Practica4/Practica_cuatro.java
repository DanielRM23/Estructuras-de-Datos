...
public class Practica_cuatro {
  ...
  //   Practica_cuatro hola = new Practica_cuatro(){};
  //   // Ejemplo, puedes borrarlo
  //   Arreglos.printArray(Arreglos.a5);
  //   Arreglos.printArray(Arreglos.b5);

  //   Arreglos.printArray(hola.arreglo_2n(Arreglos.a5, Arreglos.b5));
